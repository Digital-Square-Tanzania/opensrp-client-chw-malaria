...
import org.smartregister.chw.malaria.fragment.BaseVisitFragment;
 ...
 */
public class BaseIccmVisitAction {
    ...
    private BaseVisitFragment destinationFragment;
    private String formName;
    private String jsonPayload;
    private String selectedOption;
    private IccmVisitActionHelper iccmVisitActionHelper;
    private final Map<String, List<VisitDetail>> details;
    private final Context context;
    private final Validator validator;

    public BaseIccmVisitAction(Builder builder) throws ValidationException {
        ...
        this.iccmVisitActionHelper = builder.iccmVisitActionHelper;
    ...
    private void initialize() {
        try {
            ...
            if (iccmVisitActionHelper != null) {
                iccmVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = iccmVisitActionHelper.getPreProcessed();
                ...
                String sub_title = iccmVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = iccmVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        iccmVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = iccmVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = iccmVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = iccmVisitActionHelper.postProcess(jsonPayload);
        }

        iccmVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public BaseVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseVisitFragment destinationFragment) {
    ...
    public IccmVisitActionHelper getLDVisitActionHelper() {
        return iccmVisitActionHelper;
    }

    public void setLDVisitActionHelper(IccmVisitActionHelper iccmVisitActionHelper) {
        this.iccmVisitActionHelper = iccmVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getLDVisitActionHelper() != null) {
            setActionStatus(getLDVisitActionHelper().evaluateStatusOnPayload());
        }
    }

    public BaseIccmVisitAction.Status computedStatus() {
    ...
    public interface IccmVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseIccmVisitAction ldVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public Builder withHelper(IccmVisitActionHelper iccmVisitActionHelper) {
            this.iccmVisitActionHelper = iccmVisitActionHelper;
            return this;
        }
        ...
        public BaseIccmVisitAction build() throws ValidationException {
            return new BaseIccmVisitAction(this);
        }
    }
