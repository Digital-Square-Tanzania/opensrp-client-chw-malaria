...
public class IccmDao extends AbstractDao {
    ...
    public static IccmMemberObject getMember(String formSubmissionId) {
        ...
        DataMap<IccmMemberObject> dataMap = cursor -> {
            ...
            memberObject.setIccmEnrollmentFormSubmissionId(formSubmissionId);
